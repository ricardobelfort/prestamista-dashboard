...
import { LucideAngularModule, Plus, DollarSign, Wallet, SquarePen, Trash2, AlertTriangle, FileSpreadsheet, ArrowUpDown, ArrowUp, ArrowDown, ChevronLeft, ChevronRight } from 'lucide-angular';
